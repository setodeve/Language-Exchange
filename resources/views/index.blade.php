                ...
                <div class="card col-lg-8 my-1">
                    <div class="card-body d-flex px-0">
                        <div class='col-lg-5 col-6 d-flex justify-content-center align-items-center'>
                            <img class="avator-meetup" src="{{ $MeetingData[$i]->placeImage }}" alt="">
                        </div>

                        <div class='d-flex align-items-center'>
                            <div>
                                <p class='fw-bold'>Meetup in {{ $MeetingData[$i]->location }}</p>
                                <p>Language A: {{ $MeetingData[$i]->languageA }}</p>
                                <p>Language B: {{ $MeetingData[$i]->languageB }}</p>
                                <p>Capacity: {{ $MeetingData[$i]->max }}</p>
                            </div>
                        </div>
                    </div>
                </div>
